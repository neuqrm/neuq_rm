...
void handle_current_control(int limit_up,int limit_down)
{
//  int per_current=0;
//	per_current=(limit_up-limit_down)/7;
//	//handle_current=limit_up-(motor5.round_cnt*per_current);
//	  
//	//motor5.vpid.PID_OUT=handle_current;
