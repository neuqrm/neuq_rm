...
#define MAX_BASE_LINEAR_SPEED    100    //底盘最大平移速度，单位cm/s   
#define MAX_BASE_ROTATIONAL_SPEED    1  //7.260570f    //底盘最大旋转速度，单位rad/s    
#define NORMAL_LINEAR_SPEED    70
#define NORMAL_ROTATIONAL_SPEED  0.5
