...
#define pid_init() \
				do{ \
					...
					/*云台yaw位置环*/                    \
					pid_t.yaw_pid.position_loop.kp = 0.29; \
					pid_t.yaw_pid.position_loop.ki = 0; \
					pid_t.yaw_pid.position_loop.kd = 2.35; \
					                                    \
					/*云台yaw速度环*/                    \
				  pid_t.yaw_pid.speed_loop.kp = 100; \
				  pid_t.yaw_pid.speed_loop.ki = 0; \
				  pid_t.yaw_pid.speed_loop.kd = 135; \
					                                 \
					/*云台pitch位置环*/                    \
					pid_t.pitch_pid.position_loop.kp = 0.15; \
					pid_t.pitch_pid.position_loop.ki = 0; \
					pid_t.pitch_pid.position_loop.kd = 1.2; \
					                                      \
					/*云台pitch速度环*/                    \
				  pid_t.pitch_pid.speed_loop.kp = 220; \
				  pid_t.pitch_pid.speed_loop.ki = 0.05; \
				  pid_t.pitch_pid.speed_loop.kd = 210; \
				}while(0)                            \
