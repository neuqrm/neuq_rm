...
{  	
	json_t *root;
	char *out;           
	root = json_pack("[{sfsfsfsfsfsfsfsfsfsfsfsfsf}[fffffffffffff]]",\
		      	"linear_x", (Kinematics.actual_velocities.linear_x),\
					  "yaw_angle", (Kinematics.yaw.actual_angle),\
						"pitch_angle", (Kinematics.pitch.actual_angle),\
	          "left_distance", (left_distance),\
	          "right_distance", (right_distance),\
		        "HP", (referee_info.HP),\
	          "Shoot_Heatlimit", (referee_info.Shoot_Heatlimit),\
	          "Chassis_Power", (referee_info.Chassis_Power),\
	          "Chassis_PowerBuff", (referee_info.Chassis_PowerBuff),\
	          "Shoot_Heat", (referee_info.Shoot_Heat),\
	          "HP_Heat", (referee_info.HP_Heat),\
						...
						(Kinematics.pitch.actual_angle),\
						(left_distance),\
            (right_distance),\
			      (referee_info.HP),\
		        (referee_info.Shoot_Heatlimit),\
	          (referee_info.Chassis_Power),\
	          (referee_info.Chassis_PowerBuff),\
	          (referee_info.Shoot_Heat),\
	          (referee_info.HP_Heat),\
...
{ 
	...
	//gimbal_y.apid.target_angle = 1.0f*json_integer_value(item_obj);
  Kinematics.yaw.target_angle=1.0f*json_integer_value(item_obj); //10000;
	item_obj = json_array_get( gimbal_obj, 1 );
	//gimbal_p.apid.target_angle = 1.0f*json_integer_value(item_obj);
	Kinematics.pitch.target_angle=1.0f*json_integer_value(item_obj);
