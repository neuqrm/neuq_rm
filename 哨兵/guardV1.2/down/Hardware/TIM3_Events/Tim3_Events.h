...
#define pwm_pulse_y Kinematics.yaw.target_angular   
#define pwm_pulse_p Kinematics.pitch.target_angular                                     /*（Kinematics.yaw.target_angular)   上位机传入参数
...
#define GIMBAL_POS_EN    0   // 启动云台位置环，1使能，0失
