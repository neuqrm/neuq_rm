...
#define GIMBAL_Integral_max          10000
#define GIMBAL_IntegralSeparation    20
#define GIMBAL_vPID_max              25000
...
#define pid_init() \
				do{ \
					/*底盘速度环*/                        \
					pid_t.chassis_pid.speed_loop.kp = 3.4; \
					pid_t.chassis_pid.speed_loop.ki = 0.12; \
					pid_t.chassis_pid.speed_loop.kd = 10; \
					                                     \
					/*底盘位置环*/                        \
					...
					pid_t.trigger_pid.position_loop.kd=0.25; \
                                               \
					/*云台yaw位置环*/                    \
					pid_t.yaw_pid.position_loop.kp = 0.1; \
					pid_t.yaw_pid.position_loop.ki = 10; \
					pid_t.yaw_pid.position_loop.kd = 0.95; \
					                                    \
					/*云台yaw速度环*/                    \
				  ...
				  pid_t.yaw_pid.speed_loop.kd = 600; \
					...
					pid_t.pitch_pid.position_loop.ki = 0.3; \
...
typedef struct
{
	...
	PID_Loop_t fric1_pid;//mhp111
	PID_Loop_t fric2_pid;//mhp222
}PID_t;
...
void vpid_fric_realize(float kp_fric1,float ki_fric1,float kd_fric1,float kp_fric2,float ki_fric2,float kd_fric2);//mhp111
