...
#define YAW_RESETANGLE		2700		//yaw初始角度
#define YAW_MAXANGLE			3900		//yaw的最大角度值
#define YAW_MINANGLE			1500			//yaw的最小角度值
#define PITCH_RESETANGLE	1800		//pitch初始角度
#define PITCH_MAXANGLE		2100		//Pitch的最大角度值
#define PITCH_MINANGLE		1500		//Pitch的最小角度值
