...
#define trigger_to_motor(trigger_angular)	\
				do{                               \
					motor5.target_speed =(int)(trigger_angular*M3508_REDUCTION_RATIO); \
				}while(0)                                                            \
...
#define set_fire_speed(fire1_speed,fire2_speed) \
        do{                                                                    \
			fire1.vpid.target_speed = fire1_speed;		                         \
	        fire2.vpid.target_speed = fire2_speed;                             \
				}while(0)  				
...
void trigger_angle_control(int trigger_angle);//mhp111
