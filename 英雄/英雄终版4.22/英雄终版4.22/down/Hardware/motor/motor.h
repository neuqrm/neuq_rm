...
typedef struct{
	...
	float trigger_first_total_angle_storage;
}APID_t;
//电机参数结构体
typedef struct{
...
extern MOTOR_t motor1,motor2,motor3,motor4,motor5,motor6,gimbal_y,gimbal_p,fire1,fire2;//**********************************
...
void record_motor_callback_gimbal_y(MOTOR_t *motor, unsigned short angle, short speed, short current);
